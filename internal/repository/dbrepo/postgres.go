...
func (m *postgersDBRepo) AllUsers() bool {
	return true
}

// InsertReservation - inserts a reservation into the database
func (m *postgersDBRepo) InsertReservation(res models.Reservation) (int, error) {
...
func (m *postgersDBRepo) InsertRoomRestriction(r models.RoomRestriction) error {
	ctx, cancel := context.WithTimeout(context.Background(), 3*time.Second)
	defer cancel()
...
// SearchAvailabilityByDates - returns true if availability exists, false if no availability
